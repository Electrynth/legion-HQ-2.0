...
class ListContainer extends React.Component {
    ...
    if (currentList.mode === 'standard mode') {
      ...
      switch (rank) {
        ...
        case 'operative':
          ...
          break;
        case 'corps':
          if (currentList.unitCounts[rank] < 2 || currentList.unitCounts[rank] > 5) return errorColor;
          break;
        case 'special':
          if (currentList.unitCounts[rank] > 2) return errorColor;
          break;
  ...
  render() {
    ...
    console.log('units:', currentList.units);
    console.log('strings:', currentList.unitObjectStrings);
